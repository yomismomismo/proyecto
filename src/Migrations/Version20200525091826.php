...
final class Version20200525091826 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pedidos (id INT AUTO_INCREMENT NOT NULL, id_cliente_id INT NOT NULL, id_tarjeta_id INT NULL, nombre_cliente VARCHAR(100) NOT NULL, telefono INT NOT NULL, direccion VARCHAR(255) NOT NULL, provincia VARCHAR(100) NOT NULL, fecha_pedido DATETIME NOT NULL, estado VARCHAR(255) NOT NULL, INDEX IDX_6716CCAA7BF9CE86 (id_cliente_id), INDEX IDX_6716CCAAF1D4C0C4 (id_tarjeta_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
