...
final class Version20200525091826 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cuentas_bank (id INT AUTO_INCREMENT NOT NULL, id_cliente_id INT NOT NULL, num_tarjeta BIGINT(16) NOT NULL, ultimos_digitos INT NOT NULL, titular VARCHAR(100) NOT NULL, fecha_caducidad VARCHAR(5) NOT NULL, cvv INT NOT NULL, INDEX IDX_C3098C0C7BF9CE86 (id_cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pedidos (id INT AUTO_INCREMENT NOT NULL, id_cliente_id INT NOT NULL, tarjeta_id_id INT NOT NULL, nombre_cliente VARCHAR(100) NOT NULL, telefono INT NOT NULL, direccion VARCHAR(255) NOT NULL, provincia VARCHAR(100) NOT NULL, fecha_pedido DATETIME NOT NULL, estado VARCHAR(255) NOT NULL, INDEX IDX_6716CCAA7BF9CE86 (id_cliente_id), INDEX IDX_6716CCAAF1D4C0C4 (tarjeta_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pedidos ADD CONSTRAINT FK_6716CCAAF1D4C0C4 FOREIGN KEY (tarjeta_id_id) REFERENCES cuentas_bank (id)');
